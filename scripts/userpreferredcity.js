...
getData().then(function (data) {
    ...
    function assignValues(cityItems, option) {
        let str = '<div class="city-detail-card" style="background-image:url(priyadarshinigopal.github.io/WeatherApplication.github.io/assets/icons/Cities/' + this.cityName.toLowerCase() + '.svg)">';
